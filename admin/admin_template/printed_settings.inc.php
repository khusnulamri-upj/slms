...
/* measurement in cm */
$barcode_page_margin = 0.8;
$barcode_items_per_row = 2;
$barcode_items_margin = 0.9;
$barcode_box_width = 7.5;
$barcode_box_height = 1.4;
...
$barcode_scale = 40; // barcode scale in percent relative to box width and height
