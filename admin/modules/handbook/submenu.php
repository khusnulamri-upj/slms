...
/* handbook module submenu items */
// IP based access limitation
do_checkIP('smc');
do_checkIP('smc-handbook');

$menu[] = array('Header', __('Handbook Circulation'));
$menu[] = array(__('Start Transaction'), MODULES_WEB_ROOT_DIR.'handbook/index.php?action=start', __('Start Handbook Circulation Transaction Proccess'));
