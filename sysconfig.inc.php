...
$sysconf['mysqldump'] = '/var/www/upjserver.net/tmp/mysqldump';
// backup location (make sure it is accessible and rewritable to webserver!)
$sysconf['temp_dir'] = '//var/www/upjserver.net/tmp/slims/';
 ...
 */
$sysconf['p2pserver'][1] = array('uri' => 'http://perpustakaan.kemdiknas.go.id/libsenayan', 'name' => 'Perpustakaan Kemdiknas');
...
$sysconf['ipaccess']['smc-handbook'] = 'all';
...
if (!defined('DB_NAME')) { define('DB_NAME', 'upj_slims'); }
if (!defined('DB_USERNAME')) { define('DB_USERNAME', 'upj_slims'); }
if (!defined('DB_PASSWORD')) { define('DB_PASSWORD', 'R4H4514'); }
// database connection
